...
Sends voice messages to User via Discord using Eleven Labs TTS.
...
def send_voice_message(message: str, target: str = None, target_type: str = "auto") -> Dict[str, Any]:
    ...
    # Get default target (User's user ID) if not provided
    if not target:
...
if __name__ == "__main__":
    ...
    test_message = "Hello User, this is a test voice message from Assistant."
