...
As of December 2025, this repository has diverged so completely from the
Phase 1 foundation that GitHub reports "entirely different commit histories"
and cannot perform comparisons.
